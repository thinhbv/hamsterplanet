...
var CKFinderpath = '//' + location.hostname + ":" + window.location.port;
var editedField;

function BrowseServer( field, str_type)
{
    editedField = field; CKFinder.Popup(CKFinderpath + '/scripts/ckfinder/ckfinder.html?type=' + str_type, null, null, SetFileField);
}

function BrowseServer2( field, str_type)
{
    editedField = field; CKFinder.Popup(CKFinderpath + '/scripts/ckfinder/ckfinder.html?type=' + str_type, null, null, SetFileField);
}
