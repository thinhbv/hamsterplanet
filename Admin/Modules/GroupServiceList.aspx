<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="GroupServiceList.aspx.cs" Inherits="Admin.Modules.GroupServiceList" %>
			...
			<div class="padding-md alert-info">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<a class="btn btn-sm btn-success" href="GroupServiceAdd.aspx"><i class="fa fa-plus-circle fa-lg"></i> Thêm mới</a>
