<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="SupportAdd.aspx.cs" Inherits="Admin.Modules.SupportAdd" %>
	...
	<div class="padding-md">
		<div id="pnView" class="panel panel-default table-responsive">
			<div class="panel-heading">
				<asp:Label ID="lblTitle" runat="server" Text="Thêm mới người hỗ trợ"></asp:Label>
			</div>
			<div class="padding-md alert-info">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						...
						<a class="btn btn-sm btn-primary" href="SupportList.aspx"><i class="fa fa-ban fa-lg"></i> Hủy bỏ</a>
					</div>
					<!-- /.col -->
				</div>
				<!-- /.row -->
			...
			<div class="padding-md clearfix">
				<div class="form-horizontal no-margin">
					<div class="form-group">
						<label class="col-lg-2 control-label">Tên người hỗ trợ</label>
						<div class="col-lg-10">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" id="txtPhone" runat="server" class="form-control input-sm" data-required="true"/>
						</div>
						<!-- /.col -->
					</div>
					<!-- /form-group -->
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input type="text" id="txtSkype" runat="server" class="form-control input-sm"/>
						</div>
						<!-- /.col -->
					</div>
					<!-- /form-group -->
