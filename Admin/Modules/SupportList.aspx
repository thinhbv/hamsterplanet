<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="SupportList.aspx.cs" Inherits="Admin.Modules.SupportList" %>
			...
			<div class="padding-md alert-info">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<a class="btn btn-sm btn-success" href="SupportAdd.aspx"><i class="fa fa-plus-circle fa-lg"></i> Thêm mới</a>
