<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="PageList.aspx.cs" Inherits="Admin.Modules.PageList" %>
			...
			<div class="padding-md alert-info">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<a class="btn btn-sm btn-success" href="PageAdd.aspx"><i class="fa fa-plus-circle fa-lg"></i> Thêm mới</a>
						...
						<asp:Repeater ID="rptData" runat="server" OnItemCommand="rptData_ItemCommand">
							<ItemTemplate>
								<tr>
									...
									<td><%#BizUtils.ShowPageType(Eval("Type").ToString()) %></td>
									<td><%#Eval("Link") %></td>
									<td><%#Eval("Target") %></td>
									<td><%#BizUtils.ShowPagePosition(Eval("Position").ToString()) %></td>
									<td><%#Eval("Ord") %></td>
