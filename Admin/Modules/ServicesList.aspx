<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="ServicesList.aspx.cs" Inherits="Admin.Modules.ServicesList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div class="padding-md">
		<div id="pnView" class="panel panel-default table-responsive">
			...
			<div class="padding-md alert-info">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<a class="btn btn-sm btn-success" href="ServiceAdd.aspx"><i class="fa fa-plus-circle fa-lg"></i>Thêm mới</a>
			...
			<!-- /.padding-md -->
			<div class="padding-md filter-area">
				<div class="row">
					<div class="col-md-4 col-sm-4">
						<select id="ddlGroup" runat="server" class="input-sm form-control inline" style="width: 200px;">
						</select>
						<asp:LinkButton ID="lbtApply" runat="server" CssClass="btn btn-default btn-sm" OnClick="lbtApply_Click">Apply</asp:LinkButton>
					</div>
					<!-- /.col -->
				</div>
				<!-- /.row -->
