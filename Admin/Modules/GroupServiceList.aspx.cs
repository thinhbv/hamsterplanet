...
{
    public partial class GroupServiceList : System.Web.UI.Page
    {
        ...
        {
            List<GroupProduct> lstGr = objGr.SelectByTop("","Position = 1","Level");
        ...
        protected void rptData_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            try
            {
                ...
                {
                    case "AddSub":
                        Response.Redirect("GroupServiceAdd.aspx?Level=" + strCA, false);
                        break;
                    case "Edit":
                        if (strCA.Length > 5)
                        {
                        ...
                        Response.Redirect("GroupServiceAdd.aspx?Id=" + strId + "&Level=" + strCA, false);
                        break;
                    case "Active":
                        string strA = "";
