<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="ImagesAdd.aspx.cs" Inherits="Admin.Modules.ImagesAdd" %>
	...
	<div class="padding-md">
		<div id="pnView" class="panel panel-default table-responsive">
			<div class="panel-heading">
				<asp:Label ID="lblTitle" runat="server" Text="Thêm mới hình ảnh"></asp:Label>
			</div>
			...
			<div class="padding-md clearfix">
				<div class="form-horizontal no-margin">
					<div class="form-group">
						<label class="col-lg-2 control-label">Nhóm hình ảnh</label>
						<div class="col-lg-10">
					...
					<!-- /form-group -->
					<div class="form-group">
						<label class="col-lg-2 control-label">Tiêu đề hình ảnh</label>
						<div class="col-lg-10">
