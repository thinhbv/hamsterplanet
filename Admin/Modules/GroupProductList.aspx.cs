...
{
	public partial class GroupProductList : System.Web.UI.Page
	{
		...
		{
			List<GroupProduct> lstGr = objGr.SelectByTop("","Position = 0","Level");
		...
		protected void rptData_ItemCommand(object source, RepeaterCommandEventArgs e)
		{
			try
			{
				...
				{
					case "AddSub":
						Response.Redirect("GroupProductAdd.aspx?Level=" + strCA, false);
						break;
					case "Edit":
						if (strCA.Length > 5)
						{
						...
						Response.Redirect("GroupProductAdd.aspx?Id=" + strId + "&Level=" + strCA, false);
						break;
					case "Active":
						string strA = "";
