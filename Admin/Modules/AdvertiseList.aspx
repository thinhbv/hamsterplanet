<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="AdvertiseList.aspx.cs" Inherits="Admin.Modules.AdvertiseList" %>
	...
	<div class="padding-md">
		<div id="pnView" class="panel panel-default table-responsive">
			<div class="panel-heading">
				Quản lý quảng cáo
				<asp:Label ID="lblCount" runat="server" CssClass="label label-info pull-right"></asp:Label>
			</div>
			<div class="padding-md alert-info">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<a class="btn btn-sm btn-success" href="AdvertiseAdd.aspx"><i class="fa fa-plus-circle fa-lg"></i> Thêm mới</a>
						...
						<asp:Repeater ID="rptData" runat="server" OnItemCommand="rptData_ItemCommand">
							<ItemTemplate>
								<tr>
									...
									<td><%#Eval("Link") %></td>
									<td><%#Eval("Target") %></td>
									<td><%#BizUtils.ShowPositionAdvertise(Eval("Position").ToString()) %></td>
									<td><%#Eval("Ord") %></td>
