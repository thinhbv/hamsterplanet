<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="GroupProductList.aspx.cs" Inherits="Admin.Modules.GroupProductList" %>
			...
			<div class="padding-md alert-info">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<a class="btn btn-sm btn-success" href="GroupProductAdd.aspx"><i class="fa fa-plus-circle fa-lg"></i> Thêm mới</a>
