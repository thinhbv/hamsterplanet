<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="GroupImageList.aspx.cs" Inherits="Admin.Modules.GroupImageList" %>
	...
	<div class="padding-md">
		<div id="pnView" class="panel panel-default table-responsive">
			<div class="panel-heading">
				Quản lý nhóm hình ảnh
				<asp:Label ID="lblCount" runat="server" CssClass="label label-info pull-right"></asp:Label>
			</div>
			<div class="padding-md alert-info">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<a class="btn btn-sm btn-success" href="GroupImageAdd.aspx"><i class="fa fa-plus-circle fa-lg"></i> Thêm mới</a>
