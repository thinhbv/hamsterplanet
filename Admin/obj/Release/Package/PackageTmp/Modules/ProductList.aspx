<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="ProductList.aspx.cs" Inherits="Admin.Modules.ProductList" %>
			...
			<div class="padding-md alert-info">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<a class="btn btn-sm btn-success" href="ProductAdd.aspx"><i class="fa fa-plus-circle fa-lg"></i>Thêm mới</a>
