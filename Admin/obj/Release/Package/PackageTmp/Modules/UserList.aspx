<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage.Master" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="Admin.Modules.UserList" %>
			...
			<div class="padding-md alert-info">
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<a class="btn btn-sm btn-success" href="UserAdd.aspx"><i class="fa fa-plus-circle fa-lg"></i> Thêm mới</a>
						...
						<asp:Repeater ID="rptData" runat="server" OnItemCommand="rptData_ItemCommand">
							<ItemTemplate>
								<tr>
									...
									<td><%#Eval("Email") %></td>
									<td><%#Eval("Phone") %></td>
									<td><%#BizUtils.ShowCheckBoxStatus(Eval("Admin").ToString()) %></td>
